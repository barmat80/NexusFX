...
public class VBoxBuilder {
    ...
    public VBoxBuilder add(Node n, double insetsTop, double insetsBottom) {
        nodes.add(n);
        VBox.setMargin(n, new Insets(insetsTop, this.insetsRight, insetsBottom, this.insetsLeft));
        return this;
    }
