...
public class CustomAlertBuilder implements CustomAlertBuilders.PrimaryStage, CustomAlertBuilders.ContentText, CustomAlertBuilders.Type, CustomAlertBuilders.ConfirmationType, CustomAlertBuilders.Except, CustomAlertBuilders.Optionals {
	...
	private ButtonType[] confirmationButtons;
	...
	public CustomAlertBuilders.Optionals confirm() {
		...
		confirmationButtons = null;// No buttons means standard OK/Cancel buttons
		return this;
	}

	@Override
	public CustomAlertBuilders.ConfirmationType confirmCustom() {
		alertType = Alert.AlertType.CONFIRMATION;
		return this;
	}
	...
	@Override
	public CustomAlertBuilders.Optionals standard() {
		// Use default buttons
	...
	@Override
	public CustomAlertBuilders.Optionals buttons(ButtonType... buttons) {
	...
	public ButtonType build() {
		CustomAlert ca = new CustomAlert(primaryStage, alertType, getTitle(), header, contentText, exception, confirmationButtons);
